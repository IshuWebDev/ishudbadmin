...
<body onload="offloader()">
    ...
    <div class="desktop-view">
        ...
        <p class="footer-text"> IshuDbAdmin is Designed and Developed by Ishu Gupta. Powered by Core PHP 8.1 &copy 2022. Download This OpenSource Project From <a href="https://www.github.com/ishuweb/ishudbadmin" target="blank"> Github </a></p>
...
// CHECK IF LOGOUT STATUS IS DONE 
// If session has started and declared
if(isset($_SESSION['login-status']))
{
    if($_SESSION['login-status'] == "logout-done") {
...
// CHECK IF LOGIN STATUS ACTIVE 
// Check if SESSION has declared
if(isset($_SESSION['login-status']))
{
    // check SESSION value
    if($_SESSION['login-status'] == "active") {
