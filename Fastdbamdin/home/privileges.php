            ...
            <div class="priv-box">
                ...
                <div class="priv-btn-box">
                    ...
                    <button id="resource-limit-btn"> 
                     ...
                     <button onClick="location.href='flush_privileges.php';" id="flush-priv-btn"> 
                        Flush Privileges
                    </button>
                </div>
...
<div class="priv-gran-box-bk">
    <div id="priv-gran-dbx">
        ...
        <form id="grant-all-priv-form-id" action="granting_privileges.php" method="POST">
...
<div class="priv-revok-box-bk">
    <div id="priv-revok-dbx">
        ...
        <form id="revoke-all-priv-form-id" action="revoking_privileges.php" method="POST">
    ...
    <div id="resource-dbx">
        ...
        <p class="resource-headtext"> RESOURCES LIMIT </p>
            ...
            <div class="resource-box">
                <form id="resource-form-id" action="resource_limit.php" method="POST">
