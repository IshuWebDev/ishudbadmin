...
if(isset($_POST['f-grant-priv'])) {

            // store array in local variable
            $array_data = $_POST['f-grant-priv'];
            ...
            // check if main cretidentials are defined
                ...
                // validate and save in local variable
                    ...
                    if(isset($_SESSION['s-priv_cur_host'])) {
                        ...
                        // call function 
                    priv_grant($hostname, $username, $password, $curr_username, $curr_hostname, $priv_str);
                }
}
else {
...
function priv_grant($hostname, $username, $password, $curr_username, $curr_hostname, $priv_str) {
    ...
    try {
        ...
        // Query
        $sql = "GRANT " . $priv_str . " " . "ON *.* TO " . "'" . $curr_username . "'" . '@' . "'" . $curr_hostname . "'" . ";";
        ...
        try {
            ...
            $_SESSION['s-g-p-status'] = "failed";
            $_SESSION['s-g-p-msg'] = $errorMsg;
