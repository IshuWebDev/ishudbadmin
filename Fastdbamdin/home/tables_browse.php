            ...
            <div class="database-table-list-main-box"><!---table list -->
                <div class="db-table-list-top-box">
                    ...
                    <p class="db-table-list-selected-db"> 
                        ...
                        <button onclick="location.href='table_create.php'" id="create-new-table-btn">
                                ...
                                if($result->num_rows > 0) {
                                    while($data = $result->fetch_assoc()) {
                                        ...
                                        <div class='db-table-action-box'> <!--- each table action container box -->
                                            ...
                                            <form style='display:inline-block' action='processing_structure.php' method='post'>
...
<div class="del-tab-box-bk">
    <div id="del-tab-dbx">
        ...
        <form style='display:inline-block;' action='deleting_table.php' method='post' id='del-table-fid'>
...
<div class="renametb-box-bk">
    <div id="renametb-dbx">
        ...
        <form action="changing_tablename.php" method="post" id="renametb_form_id">
...
<div class="export-tab-box-bk">
    <div id="export-tab-dbx">
        ...
        <form style="display:inline-block" action="exporting.php" method="POST">
