                                    ...
                                    while($data = $result->fetch_assoc()) {
                                        ...
                                        <div class='user-list-bx'>
                                            ...
                                            <div class='btn-container'>
                                                ...
                                                <form style='display:inline-block;'action='home/processing_privileges.php' method='post'>
    ...
    //  USER ACCOUNT dailog box -->
            ...
            <div class='cnua-box-bk'>
                <div id='cnua-dbx'>
                    ...
                    <form action='home/creating_new_user_account.php' method='POST' id='cnu-form'>
...
<div class="cnuaname-box-bk">
    <div id="cnuaname-dbx">
        ...
        <form action="home/changing_username.php" method="post" id="chang_user_form_id">
...
<div class="cnuahost-box-bk">
    <div id="cnuahost-dbx">
        ...
        <form action="home/changing_hostname.php" method="post" id="chang_host_form_id">
...
<div class="cnuacp-box-bk">
    <div id="cnuacp-dbx">
        ...
        <form action="home/changing_password.php" method="post" id="change_pass_form_id">
...
<div class="cnuadel-box-bk">
    <div id="cnuadel-dbx">
        ...
        <form id="delete_user_acc_form_id" action="home/deletion_user_account.php" method="POST">
