            ...
            <div class="soft-info">
                ...
                <table class="soft-tab">
                    ...
                    <tr class="soft-info-tre">
                        ...
                        <td class="soft-info-tde"> 1.0.0 </td>
                    </tr>
                </table>
                <p class="soft-info-f-text"> Powered by Ishudbui.ga &copy 2022. Download from <a href="https://www.github.com/ishuwebdev/ishudbadmin"> Github </a></p>
            </div>
        </div>
    </div>
</div>
...
<div class="cndb-box-bk">
    <div id="cndb-dbx">
        ...
        <form id="cndb_form_id" action="home/creating_database.php" method="POST">
...
<div class="db-del-box-bk">
    <div id="db-del-dbx">
        ...
        <form id="del-f" action="home/deleting_database.php" method="POST">
