                                            ...
                                            while($data = $result->fetch_assoc()) {
                                                ...
                                                <tr class='table-rows-structure'>
                                                    ...
                                                    <td class='table-data-structure' style='min-width: 290px;'>
                                                        ...
                                                        <form style='display:inline-block;' action='home/processing_add_col.php' method='POST'>
                                                        ...
                                                        <form style='display:inline-block;' action='home/processing_change_column.php' method='POST'>
...
<div class="del-col-box-bk">
    <div id="del-col-dbx">
        ...
        <form id="delete_column_form_id" style='display:inline-block;' action='home/deleting_column.php' method='post'>
...
<div class="add-key-box-bk">
    <div id="add-key-dbx">
        ...
        <form id="add_key_col_form_id" style='display:inline-block;' action='home/adding_keys.php' method='post'>
...
<div class="rem-key-box-bk">
    <div id="rem-key-dbx">
        ...
        <form id="rem_pri_key_form_id" style='display:inline-block;' action='home/removing_keys.php' method='post'>
