...
<div id="green-notice-wrapper">
    ...
    <div class="main-wrapper">
        ...
        <div class="mainbox">
            ...
            <form action="home/changing_column.php" method="post" id="changing_table_form_id">
                <!--- add column in table main box. -->
                <div class="change-col-main-container">
                    
                    <div class="change-col-in-table-heading-box">
                        <p class="change-col-in-table-heading-text"> Change Column in the Table : </p> <!--- table list heading-->
                        <p class="change-col-in-table-selected-tb"> 
                            <!--- php script started --->
                            <?php 
                            if(isset($_SESSION['s-change-col-tbname'])) {
                                // show this value as selected database
                            echo $_SESSION['s-change-col-tbname'];
                            }
                            ?>
                            <!--- php script ends --->
                        </p>
                        ...
                        <!--- input #1 for current table name --->
                        <input name="f-change-col-cur-tb-name" style="display:none;" 
                        value='<?php 
                                if(isset($_SESSION['s-change-col-tbname'])) {
                                    // show this value as selected database
                                echo $_SESSION['s-change-col-tbname'];
                            ...
                            ?>'/>
                        <!--- input #2 for current database name --->
                        <input name="f-change-col-cur-db-name" style="display:none;" 
                        value='<?php 
                                if(isset($_SESSION['s-change-col-dbname'])) {
                                    // show this value as selected database
                                echo $_SESSION['s-change-col-dbname'];
                                }
                            ?>'/>
                         <!--- input #3 for current column name --->
                        <input name="f-change-col-cur-column" style="display:none;" 
                        value='<?php 
                                if(isset($_SESSION['s-change-cur_col'])) {
                                    // show this value as selected database
                                echo $_SESSION['s-change-cur_col'];
                                }
                            ?>'/>

                        <button type="reset" class="change-col-in-table-cancel">
                            <i class="fa fa-times" style="margin-right: 5px;" aria-hidden="true"></i>
                                Reset
                        </button>
                        <button name="f-change-col-in-table-submit-btn" type="submit" class="change-col-in-table-save" id="change-col-in-table-input-submit">
                    ...
                    <!--- change column box -->
                    <div class="change-col-in-table-col-box" id="change-col-in-table-col-box-id"> 
                        <!--- input #4 for column name --->
                        <input id="change-col-in-table-input-colom-name-in" name="f-change-col-in-table-input-colom-name" type="text" class="change-col-in-table-col-name" placeholder="Enter Colomn Name"/>
                        <!--- input #5 for data type --->
                        <select id="change-col-in-table-input-data-type-in" name="f-change-col-in-table-input-data-type" class="change-col-in-table-col-type">
                        ...
                        <!--- input #6 for column length --->
                        <input id="change-col-in-table-input-length-in" name="f-change-col-in-table-input-length" type="number" class="change-col-in-table-length" placeholder="Value/Lenght"/>
                         <!--- input #7 for column attribute --->
                        <select name="f-change-col-in-table-input-attribute" class="change-col-in-table-col-attr">
                        ...
                        <!--- input #8 for column comment --->
                        <textarea name="f-change-col-in-table-input-colum-comment" type="text" class="change-col-in-table-comment" placeholder="Column Comment here..."></textarea>
                        <!--- input #9 for default --->
                        <div id="change-col-in-table-col-default-container-id" class="change-col-in-table-col-default-container">
                            <select onclick="show_change_default_input()"  name="f-change-col-in-table-input-default" id="change-col-in-table-col-default-id" class="change-col-in-table-col-default">
                            ...
                            <!--- input #10 for default defined text --->
                            <input name="f-change-col-in-table-as-defined-text-in" id="change-col-in-table-as-defined-text-inp" class="change-col-in-table-as-defined-style" placeholder="Enter Default Value..."/>
                            <div type="input" onclick="hide_change_default_input()" class="change-col-in-table-defined-btn-style" id="change-col-in-table-defined-btn-style-id"> Save </div>
                        </div>
                        <!--- input #11 for null --->
                        <label>
                            <p class="change-col-in-table-null-txt"> Not Null </p>
                            <input name="f-change-col-in-table-input-null" value="NOT NULL" type="checkbox" class="change-col-in-table-null-chkbox" id="change-col-in-table-null-chkbox-id"/>
                        </label>
                        <!--- input #12 for column name --->
                        <label>
                            <p class="change-col-in-table-increment-txt"> Auto Increment </p>
                            <input name="f-change-col-in-table-input-auto-increment" value="AUTO_INCREMENT" type="checkbox" class="change-col-in-table-auto-inc"/>
                        </label>
                    </div>
                    <!--- change column in table box -->
                </div>
                <!--- change column in table main box -->
            </form>
        </div>
        <!--- main box -->
</body>
